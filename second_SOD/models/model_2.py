...
from models.module.attention import SpatialAttention, AttentionBlock, CBAM
...
class Decoder(nn.Module):
    def __init__(self, in_channel_list, img_size=224, channel=64):
        ...
        # self.down1 = RFB(in_channel_list[0], set_channels)
        # self.down2 = RFB(in_channel_list[1], set_channels)
        # self.down3 = RFB(in_channel_list[2], set_channels)
        # self.down4 = RFB(in_channel_list[3], set_channels)
