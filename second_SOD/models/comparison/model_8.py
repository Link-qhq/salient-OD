...
class LocalAttention(nn.Module):
    def __init__(self, channel=64, kernel_size=7):
        ...
        pad = kernel_size // 2
        # 考虑是否先加如 nn.Conv2d(channel, channel, 1, 1) / MLP
...
class Decoder(nn.Module):
    def __init__(self, in_channel_list, img_size=224, channel=64):
        ...
        self.se_att1 = CBAM(set_channels)
        self.se_att2 = CBAM(set_channels)
        self.se_att3 = CBAM(set_channels)
        self.se_att4 = CBAM(set_channels)
