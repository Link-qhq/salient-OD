...
class Decoder(nn.Module):
    def __init__(self, in_channel_list, img_size=224, channel=64):
        ...
        self.se_att1 = SeE_Block(set_channels)
        self.se_att2 = SeE_Block(set_channels)
        self.se_att3 = SeE_Block(set_channels)
        self.se_att4 = SeE_Block(set_channels)
        ...
        self.dce1 = SIM(set_channels, set_channels)
        self.dce2 = SIM(set_channels, set_channels)
        self.dce3 = SIM(set_channels, set_channels)
        self.dce4 = SIM(set_channels, set_channels)
