...
from models.module.common import FrozenBatchNorm2d
...
def resnet50(pretrained=None, **kwargs):
    ...
    if pretrained is not None:
        ...
        # model.load_state_dict(torch.load("/home/amax/文档/qhq/second_SOD/pretrained_model/resnet50-19c8e357.pth", weights_only=True), strict=False,)
    return model
