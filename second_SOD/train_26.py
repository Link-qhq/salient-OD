...
from models.model_26 import PGN
...
def compute_loss(out, label, boundary=None, loss_function="bce_iou", loss_weights=None, alpha=1.0, beta=1.0, theta=1.0):
    ...
    all_loss = loss_fn(out[0], label, alpha, beta) + F.binary_cross_entropy_with_logits(out[1], boundary)
    return all_loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', default='Model_26', type=str, help='M3Net with different backbone')
