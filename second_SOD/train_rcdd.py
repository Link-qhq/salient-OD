...
from models.model_8 import Decoder
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_scale', default=False, type=bool, help='is or not use scale train')
    parser.add_argument('--img_size', default=1024, type=int, help='network input size')
    ...
    parser.add_argument('--test_methods', type=str, default='RCDD', help="test dataset list")
