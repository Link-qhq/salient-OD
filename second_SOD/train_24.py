...
from models.model_24 import PGN
...
def compute_loss(out, label, loss_function="bce_iou", loss_weights=None, alpha=1.0, beta=1.0, theta=1.0):
    ...
    for i in range(len(loss_weights)):
        loss_list.append(bce_iou(out[i], label, alpha, beta) * loss_weights[i])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', default='Model_24', type=str, help='M3Net with different backbone')
