...
from models.model_25 import PGN
...
def compute_loss(out, label, boundary=None, loss_function="bce_iou", loss_weights=None, alpha=1.0, beta=1.0, theta=1.0):
    ...
    all_loss = bce_dice(out[0], label, alpha, beta) + bce_iou(out[1], boundary, alpha, beta)
    return all_loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', default='Model_25', type=str, help='M3Net with different backbone')
