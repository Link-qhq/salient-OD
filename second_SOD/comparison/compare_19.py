...
from models.comparison.model_19 import Decoder
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='../new_datasets', type=str, help='data path')
    ...
    parser.add_argument('--test_methods', type=str, default='DUTS-TE+ECSSD+PASCAL-S+HKU-IS', help="test dataset list")
    ...
    parser.add_argument("--gt_root", type=str, default="../new_datasets", help="gt root")
