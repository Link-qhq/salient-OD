...
from models.model_14 import PGN
...
def compute_loss(out, label, loss_function="bce_iou", loss_weights=None, alpha=1.0, beta=1.0, theta=1.0):
    ...
    for i in range(len(loss_weights)):
        loss_list.append(loss_fn(out[i], label) * loss_weights[i])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', default='Model_14', type=str, help='M3Net with different backbone')
