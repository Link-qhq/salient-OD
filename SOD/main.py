...
#     testing(args)
import os
datasets = ['DUTS-TE', 'ECSSD', 'PASCAL-S', 'HKU-IS']
root_dir = 'D:/working/SOD/comparison/SOD-SOTA-Saliency-maps'
for dataset in datasets:
    data_path = os.path.join(root_dir, dataset, 'DNA')
    for filename in os.listdir(data_path):
        os.rename(os.path.join(data_path, filename), os.path.join(data_path, filename.replace('_resnet', '')))