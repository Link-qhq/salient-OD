...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.fsd1 = FSDM(set_channels, group)
        self.fsd2 = FSDM(set_channels, group)
        self.fsd3 = FSDM(set_channels, group)
        self.fsd4 = FSDM(set_channels, group)
