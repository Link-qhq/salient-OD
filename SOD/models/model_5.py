...
from models.module.attention import SegNext_Attention, CAA
from models.module.BPFINet import U_shapeSelfRefinement
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        # self.refine = U_shapeSelfRefinement(set_channels)
        self.sppf = SPPF_LSKA(2048, set_channels)
        self.fusion4 = iAFF()
        self.fusion3 = iAFF()
        self.fusion2 = iAFF()
        self.fusion1 = iAFF()
        self.att1 = CAA(set_channels)
        self.att2 = CAA(set_channels)
        self.att3 = CAA(set_channels)
        self.att4 = CAA(set_channels)
    ...
    def forward(self, fea, shape):
        ...
        fea_1 = self.att1(fea_1)
        fea_2 = self.att2(fea_2)
        fea_3 = self.att2(fea_3)
        fea_4 = self.att4(fea_4)
