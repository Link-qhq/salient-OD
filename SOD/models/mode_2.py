...
class Decoder(nn.Module):
    ...
    def forward(self, fea, shape):
        ...
        out4 = self.fusion4(sppf, fea_4)
        out3 = self.fusion3(F.interpolate(out4, scale_factor=2, mode="bilinear"), fea_3)
        out2 = self.fusion2(F.interpolate(out3, scale_factor=2, mode="bilinear"), fea_2)
        out1 = self.fusion1(F.interpolate(out2, scale_factor=2, mode="bilinear"), fea_1)
