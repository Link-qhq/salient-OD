...
from models.current_best__model import PGN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', default=1.980198019801982e-05, type=float, help='learning rate')
    ...
    parser.add_argument('--weights', type=list, default=[1.0, 1.0, 0.5, 0.5], help="loss weight")
    ...
    parser.add_argument('--last_epoch', default=100, type=int, help='last saved epoch')
