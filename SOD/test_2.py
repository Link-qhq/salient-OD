...
def testing(args):
    ...
    # model.load_state_dict(torch.load('/root/autodl-tmp/SOD/results/exp_50/105_120.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='/root/autodl-tmp/salient_object_detection/datasets/datasets', type=str, help='data path')
    parser.add_argument('--method', default='mode_2', type=str, help='M3Net with different backbone')
    parser.add_argument('--save_path', default='results/exp_50/', type=str, help='save model path')
    ...
    parser.add_argument('--test_methods', type=str, default='DUT-O+DUTS-TE+ECSSD+HKU-IS+PASCAL-S+SOD', help="test dataset list")
