...
def fit(model, train_dl, test_dl, args, file_fold):
    ...
    for epoch in range(args.last_epoch, epochs):
        ...
        for i, data_batch in enumerate(progress_bar):
            ...
            progress_bar.set_postfix(avgloss=f'{(epoch_loss_out / iters):.5f}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_epochs', default=65, type=int, help='total training epochs')
    parser.add_argument('--img_size', default=352, type=int, help='network input size')
    parser.add_argument('--method', default='model_8', type=str, help='M3Net with different backbone')
