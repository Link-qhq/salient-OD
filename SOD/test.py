...
def testing(args):
    ...
    model.load_state_dict(torch.load('/root/autodl-tmp/SOD/pretrained_model/ICON-R60'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', default='results/exp_13/', type=str, help='save model path')
    ...
    parser.add_argument('--test_methods', type=str, default='ECSSD+SOD', help="test dataset list")
