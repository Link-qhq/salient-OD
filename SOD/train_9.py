...
from models.model_9 import TestMODEL
...
def fit(model, train_dl, test_dl, args, file_fold):
    ...
    scheduler = LambdaLR(optimizer=opt, lr_lambda=get_lr(30, epochs), last_epoch=-1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', default='Model_9', type=str, help='M3Net with different backbone')
