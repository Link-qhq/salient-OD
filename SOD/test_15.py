...
from models.model_15 import TestMODEL
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', default='results/exp_43/', type=str, help='save model path')
    ...
    parser.add_argument('--test_methods', type=str, default='ECSSD+DUTS-TE+HKU-IS+PASCAL-S+DUT-O+SOD', help="test dataset list")
