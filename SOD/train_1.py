...
from data.ICON_dataloader import Data
...
def fit(model, train_dl, test_dl, args, file_fold):
    ...
    for epoch in range(args.last_epoch, epochs):
        ...
        for i, data_batch in enumerate(progress_bar):
            ...
            progress_bar.set_postfix(loss=f'{loss[4].cpu().data.item():.5f}')
...
def training(args):
    ...
    #                       )
    train_dataset = Data(root=args.data_root, sets=['DUTS-TR'], mode='train')
